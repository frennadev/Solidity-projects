...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setBuyFee(
        ...
        require((totalBuyFees / 100) <= 25, "Fees Limit exceeded.");
        require((totalBuyFees / 100) > 0, "Fees cannot be set to zero.");
    ...
    function setSellFee(
        ...
        require((totalSellFees / 100) <= 25, "Fees Limit exceeded.");
        require((totalSellFees / 100) > 0, "Fees cannot be set to zero.");
    ...
    function setLimitAmount(uint256 amount) external onlyOwner {
        _limitAmount = amount;
        require((_limitAmount) >= 20000000, "Must be above 1% of total supply.");
    }
