...
contract KAKASHI is IERC20, Ownable {
    ...
    uint256 maxWallet = _totalSupply / 100; // 2%
    uint256 maxTransaction = _totalSupply / 50; // 2%
    uint256 public swapThreshold = _totalSupply / 10000; // Starting at 0.1%
    ...
    address public marketingWallet = payable(0x37a4472577Ac22BEF961ac54492F9ECE6c502Fb9);
    address public devWallet = payable(0x757E90d7d03fBa12A3076818ac03B1E8Be494E75);
