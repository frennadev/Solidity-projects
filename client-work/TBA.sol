/**
 www.thebodyarchitectsfinance.com
*/
...
contract THEBODYARCHITECT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    THEBODYARCHITECTDividendTracker public dividendTracker;
    ...
    constructor() ERC20("THEBODYARCHITECT", "$TBA") {
        marketingWallet = payable(0x757E90d7d03fBa12A3076818ac03B1E8Be494E75);
        devWallet = payable(0x757E90d7d03fBa12A3076818ac03B1E8Be494E75);
        ...
        dividendTracker = new THEBODYARCHITECTDividendTracker(
            payable(this),
            router,
            0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c,
            "THEBODYARCHITECTTRACKER",
            "THEBODYARCHITECTTRACKER"
        );
        ...
        uint256 totalTokenSupply = (4_200_00) * (10**18);
...
contract THEBODYARCHITECTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    THEBODYARCHITECT public THEBODYARCHITECTContract;
    ...
    constructor(
        ...
        defaultToken = token;
        THEBODYARCHITECTContract = THEBODYARCHITECT(mainContract);
    ...
    function _transfer(
        ...
        require(false, "THEBODYARCHITECT_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "THEBODYARCHITECT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main THEBODYARCHITECT contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(THEBODYARCHITECTContract);

            uint256 prevBalance = THEBODYARCHITECTContract.balanceOf(address(this));
            ...
            {
                uint256 received = THEBODYARCHITECTContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    THEBODYARCHITECTContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
